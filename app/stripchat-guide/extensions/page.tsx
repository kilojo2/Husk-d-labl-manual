...
const section5: ContentBlock[] = [
  ...
  },
  {
    type: "list",
    items: [
      "Вы размечаете поле (обычно 6×6 или 8×8).",
      "Зрители по очереди 'стреляют'.",
      "При попадании открывается фото или видео соответствующей зоны.",
      "Можно делать несколько уровней 'одежды' — от полностью одетой до полностью обнажённой.",
    ],
  },
  {
    type: "paragraph",
