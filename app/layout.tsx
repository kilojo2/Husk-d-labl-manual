...
function isMaintenanceMode(): boolean {
  // Check env var first (works in both Edge and Node.js)
  if (process.env.MAINTENANCE_MODE === "true") return true;

  // Check for .maintenance file in project root (Node.js runtime only)
  try {
    ...
    // fs not available (Edge runtime) — fallback to env var only
  }
...
export default function RootLayout({
  ...
  // If maintenance mode is on AND not admin page, show maintenance screen
