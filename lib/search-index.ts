...
Оффлайн-статус создаём с помощью ИИ.
  ...
  },
  {
    ...
    section: "Начало работы",
    keywords: [
      "stripchat", "настройки шоу", "приват", "цены",
      "тип-меню", "трансляция", "параметры",
    ],
    content: "Настройка параметров трансляции и приватов на Stripchat. Настройка приватных шоу, цен, тип-меню и других параметров трансляции.",
  },
  {
    title: "Лента",
